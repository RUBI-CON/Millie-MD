...
//================VERIFICATIONS==================//
        ...
        global.vidverify = {quoted:{
            ...
            message: { 
                        ...
                        "h": `ɴᴇᴇʀᴀᴊ-x0`,
                        'seconds': '404', 
                        'caption': 'MISS-DIYA-ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ',
                        'jpegThumbnail': thumburl
                               }
                              }
                            }} 
            ...
            message: {
                "productMessage": {
                    "product": {
                        ...
                        "title": "MISS-DIYA",
                        "description": "ANOOP-x0",
                        "currencyCode": "USD",
                        "priceAmount1000": "404000000",
                        "retailerId": "MISS-DIYA-ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ",
       ...
       global.troliverify = {quoted :
        ...
        //global.nd = pickRandom(['𝐓𝐄𝐀𝐌-ALEXA', '𝗧𝗘𝗔𝗠-𝗘𝗟𝗘𝗖𝗧𝗥𝗔', '𝘛𝘌𝘈𝘔-𝘌𝘓𝘌𝘊𝘛𝘙𝘈 ', '𝙏𝙀𝘼𝙈-𝙀𝙇𝙀𝘾𝙏𝙍𝘼', '𝚃𝙴𝙰𝙼-𝙴𝙻𝙴𝙲𝚃𝚁𝙰', 'ƬΣΛM-ΣᄂΣᄃƬЯΛ', 'тєαм-єℓє¢тяα', '†ÈÄM-ÈLÈÇ†RÄ', 'ᴛᴇᴀᴍ-ᴇʟᴇᴄᴛʀᴀ', '𝓣𝓔𝓐𝓜-𝓔𝓛𝓔𝓒𝓣𝓡𝓐', '𝓉𝑒𝒶𝐌-乇ᒪ𝒆℃Ŧ𝓻𝐀𝕝', '𝒯𝐸𝒜𝑀-𝐸𝐿𝐸𝒞𝒯𝑅𝒜 ', '𝒯𝐸𝒜𝑀-𝐸𝐿𝐸𝒞𝒯𝑅𝒜', '𝕋𝔼𝔸𝕄-𝔼𝕃𝔼ℂ𝕋ℝ𝔸', '🅃🄴🄰🄼-🄴🄻🄴🄲🅃🅁🄰', 'ₜₑₐₘ₋ₑₗₑCₜᵣₐ', 'ȶɛǟʍ-ɛʟɛƈȶʀǟ'])
